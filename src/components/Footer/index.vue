<template>
  <div id="footer">
    ...
    <div class="site-info">
      <p><i class="icon icon-copyright"></i>2019.06.05 <i class="icon icon-heart"></i> Margulator</p>
      <p>
        Theme -
        <a rel="noopener noreferrer" target="_blank" href="https://github.com/Margelator/aurora">Aurora</a> |
        兽炉沈水烟 - 翠沼残花片
      </p>
    </div>
